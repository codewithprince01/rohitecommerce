              ...
              {group.items.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center group text-center focus:outline-none cursor-pointer flex-shrink-0 ${
                      isWide
                        ? 'w-[218px] sm:w-[246px] md:w-[266px] lg:w-[278px]'
                        : 'w-[106px] sm:w-[120px] md:w-[130px] lg:w-[136px]'
                    }`}
                  >
                    {/* Image Card Container - Full-bleed image without grey background */}
                    <div
                      className={`h-[106px] sm:h-[120px] md:h-[130px] lg:h-[136px] rounded-2xl overflow-hidden shadow-sm group-hover:shadow-md group-hover:scale-105 group-active:scale-95 transition-all duration-200 relative ${
                        isWide ? 'w-full' : 'w-full aspect-square'
                      }`}
                    >
                      <img
                        src={item.image}
